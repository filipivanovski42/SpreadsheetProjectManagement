...
function initSprintSheet() {
  ...
  // Auto-fit columns to content, then apply minimums
  sheet.autoResizeColumns(2, 7);
  if (sheet.getColumnWidth(2) < 350) sheet.setColumnWidth(2, 350);
  if (sheet.getColumnWidth(3) < 200) sheet.setColumnWidth(3, 200);
